          ...
          <table class="table table-striped table-hover article-table">
            ...
            <?php if ($row > 0) {
                while ($data = mysqli_fetch_assoc($result)) {
                    ...
                    if ($article_trend > 0) {
                        echo '
                          <a class="btn btn-danger" href="./deactivate-trend.php?id=' .
                            $article_id .
                            '" title="Remove Article Trend">
                            <span class="glyphicon glyphicon-heart"></span>
                          </a>
                          ';
                    } else {
                        echo '
                          <a class="btn btn-warning" href="./activate-trend.php?id=' .
                            $article_id .
                            '" title="Make Article Trending">
                    ...
                    if ($article_active > 0) {
                        echo '
                          <a class="btn btn-success" href="./deactivate-article.php?id=' .
                            $article_id .
                        ...
                        echo '
                          <a class="btn btn-info" href="./activate-article.php?id=' .
                            $article_id .

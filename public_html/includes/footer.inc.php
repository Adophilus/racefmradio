...
<footer class="footer">
  <div class="footer-left">
    ...
    <p>
      RaceFm Online Radio. We bring to you the current happenings around the world from
      esteemed writers. Make sure to read up and keep up with us through this platform that we bring to you. RaceFM
    </p>
    <div class="socials">
  ...
  <ul class="footer-right">
    ...
    <li>
      ...
      <ul class="box">
        <li>
          Share the story in your own words with the world. To Inspire with your writing make RaceFM your platform to
  ...
  <div class="footer-bottom">
    <p>All Rights Reserved | Copyright &copy; <?php echo date("D")?> <?php echo date("M")?> <script>document.write(new Date().getFullYear())</script> </p>RaceFM Online Radio</p>
  </div>
</footer>

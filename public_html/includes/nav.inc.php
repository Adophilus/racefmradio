...
<head>
  ...
  <!-- TITLE OF THE PAGE -->
  <title>RaceFM | The Official News Portal | <?php echo $page_title; ?></title>
...
<body>
  ...
  <nav class="navbar">
    ...
    <ul class="ul">
      ...
      <li>
	  <li><a href"livestream.php">Radio</li>
      <li>
      ...
      <li>
        ...
        <a href="./user-login.php" <?php if ($login) {
            echo 'class="current"';
        } ?>>Login</a>

      ...
      <article class="card1">
        ...
        <div class="meta">
          ...
          <div class="date">
            ...
            <?php echo date("d M Y", $article_date); ?>
          </div>
        ...
        <div class="d-flex text-center">
          ...
          if ($bookmarked) {
              echo '<a class="btn btn-bookmark" href="remove-bookmark.php?id=' .
                  $article_id .
                  '">Remove From Bookmark &nbsp<i class="fas fa-bookmark"></i></a>';
          }

          // If the article is not bookmarked
          else {
              echo '<a class="btn btn-bookmark" href="add-bookmark.php?id=' .
                  $article_id .
                  '">Add To Bookmark &nbsp<i class="far fa-bookmark"></i></a>';
          }
          echo "&nbsp";

          // Download button
          echo '<a class="btn btn-download" target="_blank" href="download-article.php?id=' .
              $article_id .
              '">Download Article &nbsp<i class="fas fa-download"></i></a>';
          ?>
        </div>
        <?php
    }

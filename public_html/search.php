    ...
    <form method="GET" class="search-article">
      ...
      <div class="filters">
        ...
        <div>
          ...
          <input type="date" name="from_date" id="from_date" max="<?php echo date(
              "Y-m-d"
          ); ?>">
        </div>
        ...
        <div>
          ...
          <input type="date" name="to_date" id="to_date" max="<?php echo date(
              "Y-m-d"
          ); ?>">
        </div>
...
<section class="py-1 category-list">
  <div class="container">
    ...
    <div class="card-container">
      ...
      elseif ($to_date == $from_date && $to_date != "") {
      ...
      $searchQuery1 =
          $searchQuery . " ORDER BY article_title LIMIT {$offset}, {$limit}";
